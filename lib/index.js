...
var EventAsPromised = function (_EventEmitter) {
  ...
  function EventAsPromised() {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (EventAsPromised.__proto__ || (0, _getPrototypeOf2.default)(EventAsPromised)).call(this));
  }
  ...
  (0, _createClass3.default)(EventAsPromised, [{
    ...
    value: function on(name, fn) {
      return (0, _get3.default)(EventAsPromised.prototype.__proto__ || (0, _getPrototypeOf2.default)(EventAsPromised.prototype), 'on', this).call(this, name, function (_ref) {
        var args = _ref.args,
            internalEvent = _ref.internalEvent;

        return _promise2.default.resolve(fn.apply(undefined, (0, _toConsumableArray3.default)(args))).then(function (result) {
    ...
    value: function emit() {
      ...
      return new _promise2.default(function (resolve, reject) {
        ...
        (0, _get3.default)(EventAsPromised.prototype.__proto__ || (0, _getPrototypeOf2.default)(EventAsPromised.prototype), 'emit', _this2).call(_this2, name, { args: args, internalEvent: internalEvent });
